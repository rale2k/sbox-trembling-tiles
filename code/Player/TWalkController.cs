...
public partial class TWalkController : PawnController
{
	...
	[Net] public float SurfaceFriction { get; set; }

	public override void FrameSimulate()
	{
		base.FrameSimulate();

		var pl = Pawn as TPlayer;
	...
	public virtual void WalkMove()
	{
		...
		try
		{
			...
			var pm = TraceBBox( Position, dest, mins, maxs );
	...
	public virtual void StayOnGround()
	{
		...
		var trace = TraceBBox( Position, start, mins, maxs );
		start = trace.EndPosition;

		// Now trace down from a known safe position
		trace = TraceBBox( start, end, mins, maxs );
